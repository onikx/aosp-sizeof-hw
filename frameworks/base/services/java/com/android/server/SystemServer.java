    ...
    public void run() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
           ...
           try {
            ...
            // ***** <ADDED-BY-ONIK> *****
            try {
                Slog.i(TAG, "Sizeof Service");
                ServiceManager.addService(Context.SIZEOF_SERVICE, new SizeofService(context));
            } catch (Throwable e) {
                Slog.e(TAG, "Failure starting SizeofService Service", e);
            }
            // ***** </ADDED-BY-ONIK> *****
